...
export default function Home() {
  return <main>
    ...
    <nav><a className="brand" href="#top">🐾 BarkyTalk</a><div className="links"><a href="#guides">Guides</a><a href="#picks">Best picks</a><a href="#promise">Our promise</a></div><a className="pill" href="#newsletter">Join the pack</a></nav>
    ...
    <footer id="promise"><a className="brand" href="#top">🐾 BarkyTalk</a><p id="affiliate-note">BarkyTalk is reader-supported. When you buy through our links, we may earn a commission at no extra cost to you. Recommendations remain independent.</p><span>© 2026 BarkyTalk</span></footer>
  </main>;
}
